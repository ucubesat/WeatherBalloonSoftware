...
#include <CoreDeployment/Top/CoreDeploymentTopology.hpp>
...
static void signalHandler(int signum) {
    CoreDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    CoreDeployment::TopologyState inputs;
    ...
    CoreDeployment::setupTopology(inputs);
    CoreDeployment::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    CoreDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
