// ======================================================================
// \title  CoreDeploymentTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <CoreDeployment/Top/CoreDeploymentTopologyAc.hpp>
#include <CoreDeployment/Top/CoreDeploymentPacketsAc.hpp>
...
void configureTopology() {
    ...
    // tlmSend.setPacketList(CoreDeploymentPacketsPkts, CoreDeploymentPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name CoreDeployment
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        CoreDeployment::blockDrv.callIsr();
