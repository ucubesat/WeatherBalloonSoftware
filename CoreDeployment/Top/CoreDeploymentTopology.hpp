// ======================================================================
// \title  CoreDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef COREDEPLOYMENT_COREDEPLOYMENTTOPOLOGY_HPP
#define COREDEPLOYMENT_COREDEPLOYMENTTOPOLOGY_HPP
// Included for access to CoreDeployment::TopologyState and CoreDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <CoreDeployment/Top/CoreDeploymentTopologyDefs.hpp>

// Remove unnecessary CoreDeployment:: qualifications
using namespace CoreDeployment;
namespace CoreDeployment {
/**
 ...
 * CoreDeployment::TopologyState see: CoreDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type CoreDeployment::TopologyState see: CoreDeploymentTopologyDefs.hpp.
 *
